        ...
        <div class="card card-flush">
            <div class="card-header align-items-center pt-5 pb-0 gap-2 gap-md-5">
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    ...
                    <a href="{{ url('suratkeluar/create') }}" class="btn btn-primary">
                ...
                <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase table-light">
                            <th class="min-w">No.</th>
                            <th class="min-w">tanggal</th>
                            <th class="min-w">perihal</th>
                            <th class="min-w">ditujukan</th>
                            <th class="min-w">pengirim</th>
                            <th class="min-w">jenis surat</th>
                            <th class="min-w">sifat</th>
                    ...
                    <tbody class="fw-bold text-gray-600">
                        <tr class="">
                            <td>213/CB4/KP/2015</td>
                            <td data-order="2022-03-10T14:40:00+05:00">2022-03-10</td>
                            <td>Permohonan Pembuatan KARSIS atas nama Drs. ZAKARIA KASIMIN</td>
                            <td class="">Sekcam</td>
                            <td class="">Balai Pelestarian Cagar Budaya Serang</td>
                            <td class="">Surat Permohonan</td>
                            <td>Penting</td>
                            <td>
                            ...
                            <td class="">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3">Lihat Surat</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3">Review</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ asset('admin/arsip/keluar/edit') }}"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3 text-danger" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_delete_confirm">Hapus</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
                        ...
                        <tr class="">
                            <td>882/1525/Mutasi/2015</td>
                            <td data-order="2019-06-05T14:40:00+05:00">2019-06-05</td>
                            <td>Usul kenaikan pangkat</td>
                            <td class="">Camat</td>
                            <td class="">Badan Kepegawaian dan Diklat</td>
                            <td class="">Surat Keterangan</td>
                            <td>Rahasia</td>
                            <td>
                                <div class="badge badge-light-success">Disposisi</div>
                            </td>
                            <td class="">
                                <a href="#" class="menu-dropdown" data-kt-menu-trigger="click"
                                    data-kt-menu-placement="bottom-end">
                        ...
                        <x-modal id="kt_modal_delete_confirm">
                            <form action="">
                                <h2 class="modal-title">Hapus Surat Keluar</h2>
                                <p class="my-4 fs-4 lh-5">Apakah kamu yakin ingin menghapus <b>SURAT KUASA?</b>Jika
                                    iya,
                                    maka data akan terhapus permanen.</p>
                                <div class="text-end">
