...
@section('content')
                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex flex-wrap fw-bold mb-4 fs-5 text-gray-400">
                                    {{ $suratMasuk->nama_pengirim }} - {{ $suratMasuk->isi_ringkas }} -
                                    ...
                                    <a href="#" class="btn btn-sm btn-icon btn-light-primary" data-bs-toggle="modal"
                                        ...
                                        <svg width="15" height="15" viewBox="0 0 20 20" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_42_4395)">
                                                <path d="M18.3334 1.66667L9.16675 10.8333" stroke="black" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path
                                                    d="M18.3334 1.66667L12.5001 18.3333L9.16675 10.8333L1.66675 7.50001L18.3334 1.66667Z"
                                ...
                                <div class="me-0">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('download.suratmasuk', $suratMasuk->id) }}"
                                                ...
                                                <span class="svg-icon svg-icon-muted svg-icon-2">
                                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="black" stroke-width="2" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M5.83337 8.33331L10 12.5L14.1667 8.33331" stroke="black"
                                                            stroke-width="2" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M10 12.5V2.5" stroke="black" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                    Download Dokumen
                                                </span>
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('suratmasuk.edit', $suratMasuk->uuid) }}"
                                                class="menu-link px-3">
                                                <span class="svg-icon svg-icon-muted svg-icon-2">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M8 13.3333H14" stroke="#92929D" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                        ...
                                        @endif
                                        <div class="menu-item px-3">
                                            <button class="menu-link px-3" data-bs-toggle="modal"
                                                data-bs-target="#kt_modal_document">
                                                <span class="svg-icon svg-icon-muted svg-icon-2">
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                    <li class="nav-item">
                        <a class="nav-link text-active-primary py-5 me-6 active" data-bs-toggle="tab"
                            href="#kt_ringkasan">Ringkasan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-active-primary py-5 me-6" data-bs-toggle="tab"
                            href="#kt_lampiran">Lampiran</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-active-primary py-5 me-6" data-bs-toggle="tab"
                            href="#kt_lokasi">Lokasi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-active-primary py-5 me-6" data-bs-toggle="tab"
                            href="#kt_riwayat">Riwayat</a>
                    </li>
                    @if (auth()->user()->can('read-log-surat-masuk'))
                    <li class="nav-item">
                        <a class="nav-link text-active-primary py-5 me-6" data-bs-toggle="tab"
                            href="#kt_log">Log</a>
                    </li>
        ...
        <div class="row gy-5 g-xl-8 mt-5">
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="kt_ringkasan" role="tabpanel">
                    @include('partials.tabs.masuk.ringkas')
                </div>
                <div class="tab-pane fade" id="kt_lampiran" role="tabpanel">
                    @include('partials.tabs.masuk.lampiran')
                </div>
                <div class="tab-pane fade" id="kt_lokasi" role="tabpanel">
                    @include('partials.tabs.masuk.lokasi')
                </div>
                <div class="tab-pane fade" id="kt_riwayat" role="tabpanel">
                    @include('partials.tabs.masuk.riwayat')
                </div>
                @if (auth()->user()->can('read-log-surat-masuk'))
                <div class="tab-pane fade" id="kt_log" role="tabpanel">
                    @include('partials.tabs.masuk.log')
                </div>
                @endif
            </div>
    ...
    <x-modal id="kt_modal_document">
        <div class="card card-flush py-4">
            <form action="{{ route('upload.document.suratmasuk', $suratMasuk->id) }}" method="POST"
    ...
    <div class="modal fade" tabindex="-1" id="UploadLampiran">
            ...
            <div class="modal-content">
                <form action="{{ route('suratmasuk.upload.lampiran', $suratMasuk->uuid) }}" method="POST"
                    ...
                    <div class="d-flex justify-content-between py-5 px-6">
                        <div>
                            <h2 class="fw-bold">Upload Lampiran</h2>
                        </div>
                    ...
                    <div class="d-grid gap-3 pt-2 pb-5 px-6">
                        <div class="">
                            <label class="required form-label">Nama File Lampiran</label>
                            <input type="text" class="form-control" name="name" required>
                        </div>
                        <div class="">
                            <label class="required form-label">File Lampiran <small>(hanya file pdf)</small></label>
                            <input type="file" class="form-control" name="file_lampiran" required>
                        </div>
                    </div>
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_disposisi">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('suratmasuk.store.disposisi', $suratMasuk->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex justify-content-between py-5 px-6">
                        <div>
                            <h2 class="fw-bold">Disposisi </h2>
                        </div>
                    ...
                    <div class="d-grid gap-3 pt-2 pb-5 px-6">
                        <div class="">
                            <label class="required form-label">Disposisi Kepada</label>
                        ...
                        <div class="">
                            ...
                            <input type="text" name="isi_disposisi" class="form-control form-control" required />
                        </div>
                    </div>
