                        ...
                        <div class="col">
                            ...
                            <select name="diterima_oleh" id="diterima_oleh" class="form-control" data-control="select2"
                                ...
                                @foreach ($data_divisi as $divisi)
                                    <option value="{{ $divisi->name }}">{{ $divisi->kode }} -
                                        {{ $divisi->name }}</option>
                                @endforeach
                            </select>
                ...
                <form action="{{ route('data-master.komponen.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-grid gap-3 pt-2 pb-5 px-6">
                        <div class="">
                            ...
                            <input type="text" name="kode_komponen" class="form-control" placeholder="Contoh: AWD" required />
                        </div>
                        <div class="">
                            <label class="required form-label">Nama Komponen</label>
                            <input type="text" name="name" class="form-control" placeholder="Contoh: PT. Agung Wisnu Daya" required />
                        </div>
                    </div>
