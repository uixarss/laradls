...
@section('content')
            ...
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-kearsipan-table-filter="search"
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end align-items-center d-none"
                        data-kt-kearsipan-table-toolbar="selected">
                            ...
                            <th class="w-10px pe-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" type="checkbox" data-kt-check="true"
                                        data-kt-check-target="#kt_table_kearsipan .form-check-input" value="1" />
                                </div>
                            </th>
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        @foreach ($data_permission as $permission)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="#" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_edit_confirm_{{ $permission->id }}">
                                    ...
                                    <a href="{{ route('data-master.user-management.permission.destroy', $permission->id) }}"
                        ...
                        @foreach ($data_permission as $permission)
                            <!-- begin::ModalEdit -->
                            <div class="modal fade" tabindex="-1" id="kt_modal_edit_confirm_{{ $permission->id }}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('data-master.user-management.permission.update', $permission->id) }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="d-flex justify-content-between py-5 px-6">
                                                <div>
                                                    <h2 class="fw-bold">Ubah Permission</h2>
                                                </div>
                                            ...
                                            <div class="d-grid gap-3 pt-2 pb-5 px-6">
                                                <div class="">
                                                    <label class="required form-label">Nama Permission</label>
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_tambah">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('data-master.user-management.permission.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex justify-content-between py-5 px-6">
                        <div>
                    ...
                    <div class="d-grid gap-3 pt-2 pb-5 px-6">
                        ...
                        <div class="">
                            ...
                            <input type="text" name="name" class="form-control form-control"
                                placeholder="Contoh: create-surat-masuk" required />
                        </div>
                    </div>
