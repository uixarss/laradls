...
<div id="kt_content_container" class="container-xxl">
    ...
    <div class="card">
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-komponen-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Cari Komponen" />
                </div>
            </div>

            <div class="card-toolbar">
                <div class="d-flex justify-content-end gap-3" data-kt-komponen-table-toolbar="base">
                    @if (auth()->user()->can('export-komponen'))
                    <a href="{{route('data-master.export.komponen')}}" class="btn btn-outline btn-outline-primary btn-active-light-primary">
                    ...
                    @endif
                    @if (auth()->user()->can('import-komponen'))
                    <button type="button" class="btn btn-outline btn-outline-primary btn-active-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_import_komponen">
                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    @endif
                    @if (auth()->user()->can('create-komponen'))
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_komponen">
                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="d-flex justify-content-end align-items-center d-none" data-kt-komponen-table-toolbar="selected">
                    <div class="fw-bolder me-5">
                        <span class="me-2" data-kt-komponen-table-select="selected_count"></span>Terpilih
                    </div>
                    <button type="button" class="btn btn-danger" data-kt-komponen-table-select="delete_selected">Hapus
                        Terpilih</button>
                </div>
            </div>
        </div>
        ...
        <div class="card-body pt-0">
            <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_table_komponen">
                <thead>
                    <!--begin::Table row-->
                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase table-light">
                        <th class="w-10px pe-2">
                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_table_komponen .form-check-input" value="1" />
                            </div>
                        </th>
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    <tr class="">
                        ...
                        <td class="text-end">
                            @if ((auth()->user()->can('edit-komponen') || (auth()->user()->can('delete-komponen'))))
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                @if (auth()->user()->can('edit-komponen'))
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3 text-warning" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_confirm_{{ $komponen->id }}">Edit</a>
                                </div>
                                <!--end::Menu item-->
                                @endif
                                @if (auth()->user()->can('delete-komponen'))
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3 text-danger" data-bs-toggle="modal" data-bs-target="#kt_modal_delete_confirm_{{ $komponen->id }}">Hapus</a>
                                </div>
                                <!--end::Menu item-->
                                @endif
                            </div>
                    ...
                    @foreach ($data_komponen as $komponen)
                    <!-- begin::ModalDelete -->
                    <div class="modal fade" tabindex="-1" id="kt_modal_delete_confirm_{{ $komponen->id }}">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('data-master.komponen.destroy', $komponen->id) }}" method="post">
                                    @csrf
                                    @method('delete')
                                    <div class="d-flex justify-content-between py-5 px-6">
                                        <div>
                                            <h2 class="fw-bold">Hapus {{ $komponen->name }}</h2>
                                        </div>
                    ...
                    <!-- end::ModalDelete -->
                    <!-- begin::ModalEdit -->
                    <div class="modal fade" tabindex="-1" id="kt_modal_edit_confirm_{{ $komponen->id }}">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('data-master.komponen.update', $komponen) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="d-flex justify-content-between py-5 px-6">
                                        <div>
                                            <h2 class="fw-bold">Ubah Komponen</h2>
                                        </div>
                                    ...
                                    <div class="d-grid gap-3 pt-2 pb-5 px-6">
                                        <div class="">
                                            ...
                                            <input type="text" name="kode_komponen" class="form-control" value="{{ $komponen->kode_komponen }}" required>
                                        </div>
                                        <div class="">
                                            <label class="required form-label">Nama Komponen</label>
                                            <input type="text" name="name" class="form-control" value="{{ $komponen->name }}" required>
                                        </div>
                                    </div>
...
<div class="modal fade" tabindex="-1" id="kt_modal_import_komponen">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('data-master.komponen.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="d-flex justify-content-between py-5 px-6">
                    <div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('data-master.komponen.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-between py-5 px-6">
                    <div>
                        <h2 class="fw-bold">Tambah Komponen</h2>
                    </div>
...
<script>
    ...
    var KTKomponenList = function() {
        // Define shared variables
        var table = document.getElementById('kt_table_komponen');
        var datatable;
        var toolbarBase;
        var toolbarSelected;
        var selectedCount;
        ...
        // Private functions
        var initKomponenTable = function() {
            // Set date data order
        ...
        var handleSearchDatatable = () => {
            const filterSearch = document.querySelector('[data-kt-komponen-table-filter="search"]');
        ...
        var initToggleToolbar = () => {
            ...
            // Select elements
            toolbarBase = document.querySelector('[data-kt-komponen-table-toolbar="base"]');
            toolbarSelected = document.querySelector('[data-kt-komponen-table-toolbar="selected"]');
            selectedCount = document.querySelector('[data-kt-komponen-table-select="selected_count"]');
            const deleteSelected = document.querySelector('[data-kt-komponen-table-select="delete_selected"]');
