<div class="card mb-5 mb-lg-10">
    ...
    <x-modal id="UploadLokasi">
        <div class="card card-flush py-4">
            <form action="{{ route('suratkeluar.set.lokasi', $suratKeluar->id) }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="card-header">
                    <h1 class="modal-title">Tambah Lokasi</h1>
                    <input type="hidden" name="id" value="{{ $suratKeluar->id }}" hidden>
    ...
    @foreach ($data_lokasi_dokumen as $lokasi_dokumen)
        <x-modal id="edit_lokasi_{{ $lokasi_dokumen->id }}">
            <div class="card card-flush py-4">
                <form action="{{ route('suratkeluar.update.lokasi', $lokasi_dokumen->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="card-header">
