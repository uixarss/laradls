<div class="card mb-5 mb-lg-10">
                    ...
                    @foreach ($data_lokasi_dokumen as $lokasi_dokumen)
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <a href="{{ route('arsip.dokumen.delete.lokasi', $lokasi_dokumen->id) }}"
    ...
    <x-modal id="UploadLokasi">
        <div class="card card-flush py-4">
            <form action="{{ route('arsip.dokumen.set.lokasi', $document->id) }}" method="POST"
                ...
                <div class="card-body">
                    ...
                    <label class="form-label required">Kode/Nomor</label>
    ...
    @foreach ($data_lokasi_dokumen as $lokasi_dokumen)
        <x-modal id="edit_lokasi_{{ $lokasi_dokumen->id }}">
            <div class="card card-flush py-4">
                <form action="{{ route('arsip.dokumen.update.lokasi', $lokasi_dokumen->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        <label for="" class="form-label required ">Lokasi</label>
                        <select name="lokasi_id" id="" class="form-control" data-control="select2"
                            required>
                            <option value=""disabled aria-readonly="true">-- Select --</option>
                            @foreach ($data_lokasi as $lokasi)
                                <option value="{{ $lokasi->id }}"
                        ...
                        <input type="text" class="form-control" name="name"
                            value="{{ $lokasi_dokumen->name }}" required>
                    </div>
