        ...
        <div class="table-responsive">
            <table class="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9">
                <thead class="border-gray-200 fs-5 fw-bold bg-lighten">
                    <tr>
                        <th class="min-w-150px">Dari</th>
                        <th class="min-w-150px">Kepada</th>
                        <th class="min-w-250px">Catatan</th>
            ...
            <div class="modal fade" tabindex="-1" id="kt_modal_disposisi{{ $disposisi->id }}">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="{{ route('suratmasuk.update.disposisi', $disposisi->id) }}" method="POST"
